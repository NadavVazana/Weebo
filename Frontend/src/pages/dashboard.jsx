    ...
    return (
        ...
        <div className="sites-nav">
            ...
            {loggedInUser.waps.map(wap=> {
                return <div className="list-item"> <img src={require('../assets/img/icons/website-icon.svg').default} alt="website-icon" /> <li onClick={()=>setSite(wap)} key={wap._id} className={wap._id}>{wap.siteName}</li></div>
            })}
            </ul>
